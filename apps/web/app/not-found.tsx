...
/** Any URL that is not one of the app's real routes. Without this the reader
...
export default function NotFound() {
  return (
    <Card className="mx-auto max-w-xl space-y-4 text-center">
      <Logo size={56} uid="notfound" className="mx-auto" title="Standard Law" />
      ...
      <p className="text-sm leading-relaxed text-white/60">
        This address isn&apos;t part of the simulator. Everything lives under the routes
        below.
      </p>
